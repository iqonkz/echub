...
import { Briefcase, FolderKanban, FileText, Book, Settings, Calendar, Home, ChevronLeft } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeModule, onNavigate, onLogout, isCollapsed = false, onToggle }) => {
  const navItems = [
      ...
      <div className="px-4 py-4 space-y-2 shrink-0">
         {onToggle && (
            ...
            >
               ...
               {!isCollapsed && <span className="whitespace-nowrap overflow-hidden text-ellipsis">Свернуть</span>}
            </button>
         )}
